...
public class FizzbuzzTest {
    ...
    @Test
    void testGenerateListsNumbersUpToFour() {
        Fizzbuzz subject = new Fizzbuzz();
    ...
    @Test
    void testGenerateListsNumbersUpToFourteen() {
        Fizzbuzz subject = new Fizzbuzz();
        String result = subject.generate(14);
        assertEquals("1, 2, Fizz, 4, Buzz, Fizz, 7, 8, Fizz, Buzz, 11, Fizz, 13, 14", result);
    }
}
